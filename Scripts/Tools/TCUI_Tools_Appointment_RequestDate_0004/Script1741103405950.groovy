...
WebUI.click(findTestObject('Object Repository/Page_/span_Sign In'))
...
WebUI.click(findTestObject('Object Repository/Page_/td_10'))

WebUI.click(findTestObject('Object Repository/Page_/button_Password_absolute inset-y-0 right-0 _c7a854'))

WebUI.click(findTestObject('Object Repository/Page_/span_21'))
