...
WebUI.setText(findTestObject('Object Repository/Page_/input_Password_rounded-md text-primary'), '218')

WebUI.sendKeys(findTestObject('Object Repository/Page_/input_Password_rounded-md text-primary'), Keys.chord(Keys.ENTER))
