...
WebUI.click(findTestObject('Object Repository/Page_/span_Select a category'))

WebUI.click(findTestObject('Object Repository/Page_/li_License'))

WebUI.click(findTestObject('Object Repository/Page_/span_License'))
