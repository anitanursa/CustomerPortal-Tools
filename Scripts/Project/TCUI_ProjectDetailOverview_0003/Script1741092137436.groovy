...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_/input_Password_password'), '9NLz+4tGZcQ=')
...
WebUI.click(findTestObject('Object Repository/Page_/td_, Dashboard Asset Management'))
