...
WebUI.setText(findTestObject('Object Repository/Page_/input_Password_password'), 'customerfinalganti')
...
WebUI.click(findTestObject('Object Repository/Page_/a_Document'))
